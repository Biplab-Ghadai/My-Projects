        ...
        <div class="body_main_division">
            ...
            <div class="center_body_division">
                <%@include file="MenuBar.jsp" %>
                 ...
                 <h3 style="font-size: 25px; color: #0b965b; float: left; margin-top: 50px; margin-left: 50px;"> Add Books </h3>
                <div class="updated_status_division">
                    <form action="AddMyBooks" method="post">
                        <input type="text" name="my_book" placeholder="Enter Your Book Name...." class="add_books_movies_serials_textfield" /> <br/> <br/>
                        <input type="submit" value="Add Book" class="all_simple_button" />
                    </form>
                    </div>
