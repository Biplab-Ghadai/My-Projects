        ...
        <div class="body_main_division">
            ...
            <div class="center_body_division">
                ...
                <div class="main_updated_status_division">
                    ...
                    <%
                    String search_book = request.getParameter("book_search");
                    String ema11=null;
                    String name11=null;
                    String city11 = null;
                    String pic11=null;
                ...
                try
                {
                    ...
                    PreparedStatement ps=con.prepareStatement("select * from GT_ADD_BOOKS where BOOK_NAME LIKE '%"+search_book+"%'");
