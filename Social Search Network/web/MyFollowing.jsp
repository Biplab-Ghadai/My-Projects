                ...
                <div class="main_updated_status_division">
                    ...
                    <%
                        ...
                        try {
                            ...
                            PreparedStatement ps = con.prepareStatement("select * from GT_FOLLOWING where KON_EMAIL='" + uemail + "' ");
                            ResultSet rs = ps.executeQuery();
                            while (rs.next()) {
                                semail = rs.getString("KISKO_EMAIL");
                                name11 = rs.getString("KISKO_NAME");
                                profile_pic11 = rs.getString("KISKO_PROFILE_PIC");
