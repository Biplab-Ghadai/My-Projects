        ...
        <div class="body_main_division">
            ...
            <div class="center_body_division">
                ...
                <div class="main_updated_status_division">
                    ...
                    <%
                    String search_tv_serial = request.getParameter("tv_search_search");
                    String ema11=null;
                    String name11=null;
                    String city11 = null;
                    String pic11=null;
                ...
                try
                {
                    ...
                    PreparedStatement ps=con.prepareStatement("select * from GT_ADD_TV_SERIALS where TV_SERIAL_NAME LIKE '%"+search_tv_serial+"%'");
